...
public class Main {
    public static void main (String[] args) {
        ...
        // System.out.print(BruteForceDetector.detectBruteForce(new String[] {"192.168.1.1 LOGIN_FAIL user=admin", "192.168.1.1 LOGIN_FAIL user=admin", "192.168.1.1 LOGIN_FAIL user=admin"}));
    }
}
